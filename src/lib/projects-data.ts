...
export const projects: Project[] = [
  ...
  },
  {
    ...
    fullDescription: "Step into the quiet beauty of our studio portraits, where every image tells a story through light, emotion, and atmosphere. From a man's calm reflection set against the vibrant Nairobi nightlife to intimate close-ups that highlight character and personality, our portraits are crafted to feel authentic and cinematic. Each shot captures more than a face—it captures a mood, a moment, and the unique essence of every individual who steps in front of our lens.",
    date: 'October 2025',
    location: 'Nairobi, Kenya',
  ...
  },
  {
    ...
    category: 'Graduation',
    shortDescription: "Happines of Graduations .",
    fullDescription: "Graduation is more than a ceremony—it’s a moment of pride, joy, and new beginnings. Our graduation portraits capture the excitement in every smile, the confidence in every pose, and the happiness shared between graduates and their families. We focus on preserving the emotion of this milestone, turning each image into a celebration of hard work, dreams fulfilled, and the bright future ahead",
    date: 'July 2025',
    location: 'Nairobi, Kenya',
    equipment: 'Nicon Q2',
  ...
  },
  {
    ...
    fullDescription: "Celebrate the magic of childhood with our birthday baby portraits—capturing every giggle, curious glance, and joyful moment that makes their special day unforgettable. Each shot is crafted with warmth and creativity, turning simple moments into timeless memories that families can cherish for years. Whether it’s their first birthday or a milestone celebration, we highlight the personality, innocence, and happiness of your little one in beautifully styled, heartwarming images.",
    date: 'May 2025',
    location: 'Nairobi, Kenya',
